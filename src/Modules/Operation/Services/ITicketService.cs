...
{
    Task<Ticket> CreateAsync(Guid tenantId, Guid? branchId, Guid createdBy, string? CustomerName, Guid? deviceId, string title, string description, Priority priority, CancellationToken ct);
